...
namespace MS.Log4Unity
{
    internal class Configurator
    {
        ...
        public static void Load(string configFile)
        {
            ...
            {
                throw new Exception($"configFile not found at {configFile}");
            }
        }
        ...
        public static void LoadFromResources(string configFile)
        {
            ...
            {
                throw new Exception($"configFile not found at Resources/{configFile}");
            }
        }
        ...
        public static void ConfigurateLogger(ULogger logger, string catagoryName)
        {
            ...
            var catagory = GetCatagory(catagoryName);
            if (catagory == null)
            {
                catagory = GetCatagory(DEFAULT_CATAGORY);
            }
        ...
        internal static LogLevel ParseLogLevel(string level)
        {
            ...
            LogLevel ret;
            if (Enum.TryParse<LogLevel>(level, true, out ret))
            {
                return ret;
            }
            else
